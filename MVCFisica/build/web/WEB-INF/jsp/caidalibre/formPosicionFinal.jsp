...
<html>
    ...
    <body>
        ...
        <center><h1>Calcular Posicion Final</h1></center>
        <div class="container">
            <h3>Ingrese los valores</h3>
            <hr>
            <form action="calcularpf.htm" method="post" class="form-control" style="width: 500px; height: 230px">
                Altura
                <input type="text" name="txtAltura" class="form-control"required/>
                <br>
                Tiempo:
